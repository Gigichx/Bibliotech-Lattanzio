    ...
    <div class="login-card" style="max-width: 480px;">
        ...
        <?php if ($error): ?>
            ...
            <div class="text-center mb-4">
                ...
                <p style="color: var(--text-muted); font-size:0.88rem; margin:0;">
                    Non è stato possibile verificare il tuo link.
                </p>
            </div>
            ...
            <div style="
                ...
                line-height: 1.8;
            ">
                <strong style="color: var(--text); display:block; margin-bottom:0.3rem; font-size:0.78rem; text-transform:uppercase; letter-spacing:0.05em;">
                    Possibili cause
                </strong>
            ...
            <a href="/login.php" class="btn-primary-bt w-100 py-2">
        ...
        <?php else: ?>
            ...
            <div class="text-center">
                ...
                <p style="color: var(--text-muted); font-size:0.88rem; margin:0;">
                    Stiamo verificando il tuo link di accesso.<br>Sarai reindirizzato a breve.
                </p>
            </div>
